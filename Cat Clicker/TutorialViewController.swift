...
class TutorialViewController: UIViewController {
    ...
    @IBAction func nextButtonDidTouch(_ sender: Any) {
        count += 1
        if count == 2 {
            label.text = "A recent science discovery showed that certain cats summon coins when poked!"
            ...
            label.text = "And special training allows them to summon more coins per poke, called CpC."
